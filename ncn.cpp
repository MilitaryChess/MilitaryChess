...
* @version		0.0.1
*/
void LBChess::parse_ncn(string ncn, int& cnt, int& total_cnt)
{
    string temp = "";
...
* @version		0.0.1
*/
string LBChess::board_to_ncn(const array<array<int, 5>, 13>& board)
{
    string ncn = "";
    for (int i = 0; i < 13; i++) {
        if (i)
...
* @version		0.0.1
*/
array<array<int, 2>, 2> LBChess::parse_ncn_move(string move)
{
...
* @version		0.0.1
*/
string LBChess::move_to_ncn(const array<array<int, 2>, 2>& arr)
{
    string ncn = "";
